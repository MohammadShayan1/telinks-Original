    ...
    <div class="container" data-aos="fade-up" data-aos-duration="1000">
        ...
        <?php foreach ($images as $image): ?>
            <div class="item <?php echo htmlspecialchars($image['category']); ?> col-lg-3 col-md-4 col-6 col-sm">
                <a href="../admin/<?php echo htmlspecialchars($image['url']); ?>" class="fancylight popup-btn" data-fancybox-group="<?php echo htmlspecialchars($image['category']); ?>">
                    <img class="img-fluid" src="../admin/<?php echo htmlspecialchars($image['url']); ?>" alt="<?php echo htmlspecialchars($image['alt_text']); ?>">
                </a>
            </div>
        <?php endforeach; ?>
    </div>
