            ...
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    ...
                    <div class="iframe-container">
                        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSehfjy7pmYqONZl3Xy1i1GDZpoL-umUDmaUPQ305VOxNxTWpA/viewform?embedded=true" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
                    </div>
                </div>
                <div class="col-lg-5 mt-5 mt-lg-0">
                    ...
                    <div class="mb-4">
                        <h5>Socials</h5>
                        <a class="me-2" href="https://www.instagram.com/te.links"><i class='fab fa-instagram' style='font-size:24px;color:#1c1c1c'></i></a>
